...
* Alternatively, proportion/percent bar charts display class probabilities
...
* If we are only interested in comparing A vs B and nothing else, then just construct 95% CI for A vs B and control error rate at 5%
