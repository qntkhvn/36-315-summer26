...
* **KDE is nonparametric: pick a bandwidth and kernel, then fit a kernel-smoothed density**
...
* See the [`ggridges`](https://cran.r-project.org/web/packages/ggridges/vignettes/introduction.html) package for a variety of customization options

* Useful for displaying conditional distributions across many levels

* See also: [`ggdist`](https://mjskay.github.io/ggdist)
