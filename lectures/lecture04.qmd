...
## Mosaic plots, `ggplot2` version

::: columns
::: {.column}

Check out the [`marimekko`](https://gogonzo.github.io/marimekko) package
...
titanic |> 
  ...
  ggplot(aes(fill = Survived, weight = n)) +
  geom_marimekko(formula = ~ Pclass | Survived)
```
...
<center>
![](https://platform.vox.com/wp-content/uploads/sites/2/chorus/uploads/chorus_asset/file/3332436/hickey-bechdel-11.0.png){height=600}
</center>